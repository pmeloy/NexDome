...
; Generated by Patrick Meloy on 4/24/2018 (UTC)
;
[Setup]
AppID={{050f7d55-c99f-40c6-ac17-70b0395332fb}
AppName=ASCOM PDMDome Dome Driver
AppVerName=ASCOM PDMDome Dome Driver 0.5.0
AppVersion=0.5.0
...
OutputDir="."
OutputBaseFilename="PDMDome Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Dome\PDMDome"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Dome\PDMDome"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "D:\Programming\NexDomeGit\NexDome\PDMDome\PDome\bin\Release\ASCOM.PDome.Dome.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "D:\Programming\NexDomeGit\NexDome\PDMDome\PDome\ReadMe.htm"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.PDome.Dome.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.PDome.Dome.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.PDome.Dome.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.PDome.Dome.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.PDome.Dome.dll"""; Flags: runhidden 64bit; Check: IsWin64
